...
printf '%s\n' '== Objetivo =='
printf '%s\n' '- Restaurar contrato completo Fase 41.'
printf '%s\n' '- Mantener soporte Fase 42: PatternVariant con measurements.'
printf '%s\n' '- Restaurar edit_history, editable_variant y operaciones move_point/move_line/scale_line/adjust_curve.'
...
cat > docs/69_Fix_Fase_42_Contrato_Unificado_Fase41_Fase42.md <<'MD'
# Fix Fase 42 - Contrato unificado Fase 41/Fase 42
